...
class color_eventRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type color_eventRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type color_eventRequest
    let len;
    let data = new color_eventRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new color_eventRequest(null);
    if (msg.b !== undefined) {
      resolved.b = msg.b;
    }
    else {
...
class color_eventResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type color_eventResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type color_eventResponse
    let len;
    let data = new color_eventResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'color_shape_pair_pkg/color_eventResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new color_eventResponse(null);
    if (msg.s !== undefined) {
      resolved.s = msg.s;
    }
    else {
...
module.exports = {
  Request: color_eventRequest,
  Response: color_eventResponse,
  md5sum() { return '6e158a8fb52b65fbc6ac817be43be292'; },
  datatype() { return 'color_shape_pair_pkg/color_event'; }
};
