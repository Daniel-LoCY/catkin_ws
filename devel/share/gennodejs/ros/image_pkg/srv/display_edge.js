...
class display_edgeRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type display_edgeRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type display_edgeRequest
    let len;
    let data = new display_edgeRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new display_edgeRequest(null);
    if (msg.a !== undefined) {
...
class display_edgeResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type display_edgeResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type display_edgeResponse
    let len;
    let data = new display_edgeResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new display_edgeResponse(null);
    if (msg.b !== undefined) {
...
module.exports = {
  Request: display_edgeRequest,
  Response: display_edgeResponse,
  md5sum() { return 'fdd66f87794e274f242af2380bc3fd1f'; },
  datatype() { return 'image_pkg/display_edge'; }
};
